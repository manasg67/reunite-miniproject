        ...
        <div className="flex items-center relative top-8 w-full px-6 mx-2 sm:mx-5 my-10 rounded max-w-lg bg-white bg-opacity-80">
          <div className="flex-1">
            ...
            <div className="mt-8">
              <form>
                <div>
                  <label htmlFor="email" className="block mb-2 text-sm text-gray-600 dark:text-gray-200">{t('login.email')}</label>
                  <input name="email" id="email" placeholder="example@example.com" className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                </div>

                <div className="mt-6">
                  <div className="flex justify-between mb-2">
                    <label htmlFor="password" className="text-sm text-gray-600 dark:text-gray-200">{t('login.password')}</label>
                    <a href="#" className="text-sm text-gray-400 focus:text-blue-500 hover:text-blue-500 hover:underline">{t('login.forgot_password')}</a>
                  </div>
              ...
              <p className="mt-6 text-sm text-center text-gray-400">
                {t('login.no_account')} <a href="#" className="text-blue-500 focus:outline-none focus:underline hover:underline">{t('login.sign_up')}</a>.
              </p>
            </div>
          </div>
        </div>
